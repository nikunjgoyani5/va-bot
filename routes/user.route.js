...
route.patch("/fcm-token", verifyToken, validate(userValidation.updateUserFCMToken), userController.updateUserFCMToken);
...
route.post("/verify-2fa-otp", verifyToken, userController.verif2faOtp);

// ---------------------------------------------- Google Mails ----------------------------------------------

route.get("/google/emails", verifyToken, userController.getMails);
route.post("/google/send-mail", verifyToken, validate(userValidation.sendMail), userController.sendMail);
